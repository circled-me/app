...
class GroupMessage {
  ...
  int _type = plain;
  GroupMessage(this.id, this.groupID, this.clientStamp, this.serverStamp, this.userID, this.userName, this.content);
  ...
  Widget getContent(BuildContext context, double fontSize, Color fontColor) {
    ...
    if (_type == image) {
      final url = _imageRegex.firstMatch(content)!.group(1)!;
      return Padding(
